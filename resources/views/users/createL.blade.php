    ...
    <div class="container-fluid">
        ...
        <div id="">
                ...
                <div class="container">
                    ...
                    <h3 class="text-center text-color">Renseignez les informations sur le bien à mettre en location</h3><br>
                        ...
                        <div class="col-md-12 animate-box" >
                            <div class="feature-left">
                                <form method="post" action="{{route('store-offre')}}" class="search-property-1" enctype="multipart/form-data">
                                    ...
                                    <div class="row">   
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4 align-items-end">
                                            <div class="form-group">
                                                <div class="">
                                                    ...
                                                    <select id="" class="form-control " style="height: 45px !important;" name='ville'>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4 align-items-end">
                                            <div class="form-group">
                                                <div class="form-field">
                                                    {{-- <div class="icon"><span class="ion-ios-search"></span></div> --}}
                                                    <select id="" class="form-control " style="height: 45px !important;" name='type_bien'>
                                    ...
                                    <div class="row">
                                        <span>Aperçu des images. Veuillez sélectionnez l'image primncipale</span>
