...
<body>
    <div id="fh5co-wrapper">
        <div id="fh5co-page">
            ...
            <div class="compte " style="height: 100vh !important;">
                <section class=" container align-items-center">
                    <div class="row ">
                        <div class="col-md-3"></div>
                        <div class="col-md-6 compte-session">
                            <div class="contact-form" style="">
                                <div class=""><h2 class="h2 title text-center" style="color: rgb(12, 12, 12); margin-top: 3vh; text-align: center;">--- CREER UN COMPTE ---</h2></div><br>
                                <div id="" class="row" name="contactform" method="" style="display: flex; justify-content: center; align-items: center; text-align: center;">
                                    <form style="" class="" id="" action="{{route('admin.register')}}" method="POST">
                                        @method('post')
                                        @csrf
                                        <input type="hidden" id="use" name="type_user" value="admin">
                                        <div class="form-group">
