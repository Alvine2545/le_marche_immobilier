                ...
                <div class="modal-dialog modal-dialog-centered modal-md " role="document">
                    <div class="modal-content modal-custom">
                        ...
                        <div class="modal-body">
                            ...
                            <p>Vous n'avez pas de compte ? Créez un compte <a class="text-black" href="{{route('register')}}">ici</a></p><br>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-6 compte-session">
                            <div class="contact-form" style="">
                                <div class=""><h2 class="h2 title text-center" style="color: rgb(12, 12, 12); margin-top: 3vh; text-align: center;">Inscription</h2></div><br>
                                <div id="" class="row" action="" wire:submit.prevent='' name="contactform" method="" style="display: flex; justify-content: center; align-items: center; text-align: center;">
                                    <div id="etape1">
                                    <div class="h2 title"> <label for=""> Choisissez votre type de compte</label> </div>
                                        <button class="btn btn-round-custom btn-custom mt-5 mb-2 type" style="font-size: 20px; font-weight: bold; width: 80%;" value="particulier"> Particulier - 1000F</button>
                                        <button class="btn btn-round-custom btn-custom mt-5 mb-2 type" style="font-size: 20px; font-weight: bold; width: 80%;" value="agent"> Agent immobilier - 1500F</button>
                                        <button class="btn btn-round-custom btn-custom mt-5 mb-5 type" style="font-size: 20px; font-weight: bold; width: 80%;" value="agence"> Agence immobilière - 2000F</button>
                                    </div>
                                    {{-- Particulier --}}
                                    <form style="display: none" class="" id="Part" action="{{route('register')}}" method="POST">
                                        @method('post')
                                        @csrf
                                        <input type="hidden" id="use" name="type_user" value="">
                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">Nom</label>
                                            <input type="text" class="form-control" id="exampleFormControlInput1"
                                                placeholder="Votre nom " required name="name">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">Prénom (s)</label>
                                            <input type="text" class="form-control" id="exampleFormControlInput1"
                                                placeholder="Votre prénom" required name="prenoms">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">Confirmer le mot de passe</label>
                                            <input type="password" class="form-control" id="exampleFormControlInput1"
                                                placeholder="Retapez le mot de passe" required name="confirme_password">
                                        </div>
                                        <div class="mb-3">
