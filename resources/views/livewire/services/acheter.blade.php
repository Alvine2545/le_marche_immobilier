<div class="fh5co-page-title  section1" style="height: 350px;" >
            ...
            <div class="container ">
                <div class="row h-75">
                    <div class="col-md-12 animate-box fadeInUp animated-fast text-center text-color" wire:ignore>
                        ...
                        <h3 class="title"> Acceuil >> Services >> Acheter</h3>
            ...
            <div id="">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class=" container col-md-5 col-sm-8 col-10 animate-box icon-custom h-100 d-flex " wire:ignore>
                            <div class="col-md-7 col-sm-7 col-7 ">
                                <img src="{{asset('images/doctors-1.jpg')}}" class="h-100 w-100 img-rounded-custom img-responsive"
                        ...
                        <div class=" container col-md-5 col-sm-8 col-11 animate-box icon-custom h-100 d-flex" wire:ignore>
                            <div class="col-md-7 col-sm-7 col-7 ">
                                <img src="{{asset('images/doctors-1.jpg')}}" class="h-100 w-100 img-rounded-custom img-responsive"
                                    style="margin-left: -30.19px; object-fit:cover"></i>
                            </div>
