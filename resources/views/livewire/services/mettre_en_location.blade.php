...
<div class="fh5co-page-title section1" style="height: 50% !important; height: 350px;">
    ...
    @endif
            <div id="">
                <h3></h3>
                <div class="container">
                    <h2 class="text-center text-color">Procédure de mise en location de biens immobiliers</h2>
                    <div class="row">
            ...
            <div id="">
                ...
                <div class="container">
                    ...
                    <h3 class="text-center text-color">Remplissez ce formulaire pour mettre en location votre bien
                        immobilier</h3><br>
                                ...
                                <div class="cardbox-body" >
                                    <form class="form-validate" id="example-form" action="#" wire:submit.prevent='store_bien_location' enctype="multipart/form-data">
                                        <div>
                                            @if ($currentSteep == 1)
                                                <div>
                                                    <h4><span class="number text-bold" _istranslated="1">1. </span>Identification du locataire </h4>
                                                    <fieldset>
