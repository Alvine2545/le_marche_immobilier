<div class="fh5co-page-title section1" style="height: 50% !important; height: 350px;">
            ...
            <div id="">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 animate-box" wire:ignore>
                            <div class="feature-left">
                                <form method="post" wire:submit.prevent='' class="search-property-1" enctype="multipart/form-data">
                                    @csrf
                                    @method('post')
                                    {{-- <div class="row" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4 align-items-end">
                                            <div class="form-group">
                                                <div class="form-field">
                                                    <div class="icon"><span class="ion-ios-search"></span></div>
                                                    <input type="text" class="form-control" placeholder="Pays" wire:model='pays'>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4 align-items-end">
                                            <div class="form-group">
                                                <div class="form-field">
                                                    <div class="icon"><span class="ion-ios-search"></span></div>
                                                    <input type="text" class="form-control" placeholder="Adresse" wire:model='adresse'>
                                                </div>
                                            </div>
                                        </div>
                                    </div><br>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4 align-items-end">
                                            <div class="form-group">
                                                <div class="">
                                                    <div class="icon"><span class="ion-ios-search"></span></div>
                                                    <select name="" class="form-control " style="height: 45px !important;" wire:model='ville'>
                                    ...
                                    <div class="row form-group form-field">
                                        <div class="col-md-5 col-sm-5 col-xs-5"><label for="">Photos du bien</label></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12" style="margin-left: 0% ;">
                                            <div class="form-group">
                                                <div class="form-field">
                                                    <textarea name="" cols="30" rows="10"placeholder="Tapez votre message" class="form-control" wire:model='description'></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        document.addEventListener('livewire:load', function () {
            const photosInput = document.querySelector('input[type="file"][wire:model="photos"]');
