<div class="fh5co-page-title  section1" style="height: 350px;" >
            ...
            <div class="container ">
                <div class="row h-75">
                    <div class="col-md-12 animate-box fadeInUp animated-fast text-center text-color" wire:ignore>
                        ...
                        <h1 class="title"> Acceuil >> Services >> Louer</h1>
            ...
            <div id="">
                ...
                <div class="container"><br>
                    <h3 class="text-center text-color ">Louez votre bien immobilier en toute sécurité</h3><br>
                    {{-- <div class="row">
                                ...
                                @foreach ($recherche as $bien)
                                    <div class=" container col-md-5 col-sm-8 col-10 icon-custom h-100 d-flex" >
                                        ...
                                        <div class="col-md-5 col-sm-5 col-5 text-break justify-content-center text-center">
                                            ...
                                            <span class="float-right mb-4"> <a href="{{url('offres/'.$bien->id)}}" style="color: black; border: none; cursor: pointer; text-decoration: none;"  value="Consulter l'offre"
